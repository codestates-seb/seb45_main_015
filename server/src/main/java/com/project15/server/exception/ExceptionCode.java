...
public enum ExceptionCode {
    ...
    STAR_RATING_NOT_FOUND("STAR_RATING_NOT_FOUND", 404),
    ...
    STAR_RATING_EXIST("STAR_RATING_EXIST", 403),
    IMAGE_UPLOAD_FAIL("IMAGE_UPLOAD_FAIL", 400),
    SELLER_MISS_MATCH("SELLER_MISS_MATCH", 400),
    SELLER_OR_BUYER_MISS_MATCH("SELLER_OR_BUYER_MISS_MATCH", 400),
    ...
    NOT_IN_TRADING("NOT_IN_TRADING", 400),
    NOT_IN_CLOSED("NOT_IN_CLOSED", 400);
